...
void Left(int file_descriptor, int intensity); // Commande l'ampoule gauche
void Top(int file_descriptor, int intensity); // Commande l'ampoule du haut
void Right(int file_descriptor, int intensity); // Commande l'ampoule droite
